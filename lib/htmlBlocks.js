...
const managerBlock = function (data) {
    ...
    <div class= "card-body">
            <div class="list-group">
                ...
                <p class="list-group-item list-group-item-action list-group-item-dark">Email: <span><a href="mailto:${data.email}">${data.email}</a></span></p>
...
const engineerBlock = function (data) {
    ...
    <div class= "card-body">
            <div class="list-group">
                <p class="list-group-item list-group-item-action list-group-item-dark">ID: <span>${data.id}</span></p>
                <p class="list-group-item list-group-item-action list-group-item-dark">Email: <span><a href="mailto:${data.email}">${data.email}</a></span></p>
                <p class="list-group-item list-group-item-action list-group-item-dark">GitHub: <span><a href="https://github.com/${data.github}">${data.github}</a></span></p>
            </div>
    </div>
</div>
